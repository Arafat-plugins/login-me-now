...
* New: Browser token Table
* Improved: Expiration time set
* Improved: Browser extension popup
* Drop: Success message to fix the get_screen error
* Drop: Logs
* Fix: Google Login

= 0.99(Beta) – Jul 03, 2023 =
* Fix: Security
* New: Google Login Pro Version

= 0.98(Beta) – May 13, 2023 =
* New: Google Login
